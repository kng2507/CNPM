namespace GUI.UC
{
    partial class uc_home
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tableLayoutPanel1.Controls.Add(this.chartStatistical, 0, 0);
            this.tableLayoutPanel1.Controls.Add(this.chartQuantityImportOrder, 1, 0);
            this.tableLayoutPanel1.Controls.Add(this.chartTopSelling, 0, 1);
            this.tableLayoutPanel1.Controls.Add(this.chartNotStock, 1, 1);
            ...
            this.chartStatistical.Legend.Name = "Default Legend";
    ...
    "values.";
            ...
            createRotatedFullStackedBarChartItem1.Description = "Compare the percentage each value contributes to a total across categories using " +
    "horizontal rectangles.\n\nUse it when the values on the chart represent durations " +
    "or when the category text is very long.";
            createRotatedFullStackedBarChartItem1.Hint = "Compare the percentage each value contributes to a total across categories using " +
    "horizontal rectangles.\n\nUse it when the values on the chart represent durations " +
    "or when the category text is very long.";
    ...
    "mn represents a range of data with two values for each argument value.";
        ...
        private DevExpress.XtraCharts.ChartControl chartTopSelling;
        private DevExpress.XtraCharts.ChartControl chartNotStock;
    }
}
